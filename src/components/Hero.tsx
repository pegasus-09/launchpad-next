    ...
    <section className="relative overflow-hidden py-40 bg-white">
      <div className="mx-auto max-w-3xl px-6 text-center white">
        ...
        <div className="mt-10 flex justify-center gap-4">
          <button className="rounded-lg bg-violet-500 px-6 py-3 font-medium text-white hover:bg-violet-600">
            Let's go
          </button>
          <button className="rounded-lg border border-teal-400 px-6 py-3 font-medium text-teal-500 hover:bg-teal-50">
            Learn more
          </button>
        </div>
      </div>
